 ...
 * This version:
 * @author Aneudys Germosen
 * @version September 2017
 */
public class ChatBotAneudys
{
	...
	private String [] randomAlternativeRockResponses = { "Interpol","Strokes","Yeah Yeah Yeahs"};
	private String [] randomJazzArtistResponses = { "Miles Davis","Bill Evans","John Coltarne"};
	private String [] randomRapArtistResponses = {"A$AP Rocky","Travis Scott","Kanye West A.K.A YEEZUS"};
